...
\setromanfont[Ligatures={Common}]{DovesType-Regular.otf}
\setsansfont{Andika}
\setmathfont{Asana Math}[Scale=1]
\newfontfamily\TrajanP[Scale=1.0]{TRAJANPRO-REGULAR.OTF}
\newfontfamily{\cnfamily}[Scale=1.0]{SIMSUN.TTC}
% \usepackage{CJKutf8}
% \usepackage{pstricks}
\usepackage{varwidth}
\usepackage{siunitx}
\usepackage{graphicx}
\usepackage[margin=1.5cm,top=1.0cm]{geometry}
...
\AddToHook{shipout/background}{%
    \put (0in,-\paperheight){\includegraphics[width=\paperwidth,height=\paperheight]{images/cnybkg1.jpg}}%
}
...
\newtcolorbox{MyOuterBox}{%
  enhanced,
  watermark graphics=images/CNYrabbitWM.jpg,
  ...
  colback=JISivory,
  colframe=JISpurple,
  title={\includegraphics[width=0.9cm,height=0.9cm]{images/JIS Final Logo FA-02.png}\raisebox{3mm}{\Large{CNY Maths Challenge}\hspace{22em} \Large{\bfseries\sffamily 18}}},
}
...
\begin{document}
  \begin{center}
    \includegraphics[width=8cm,height=10cm]{images/pngtree-korean-new-year-2023-hanbok-rabbit-for-spring-festival-png-image_6131981.png}
  \end{center}
  ...
  \begin{MyOuterBox}
    \iftoggle{SOLUTION}{Here are the full, or partial solutions.
      ...
      \begin{center}
      {\Huge\cnfamily 新年快乐}\par
      Welcome to the Chinese New Year Maths Challenge!\\
      Have a go at both questions!\\
      Drop your solution in the box in the staffroom by Tuesday \(31^{st}\) January.
    \end{center}
    }
    \vspace{4.0cm}
    \input{files/No18-Lower.tex}
    \vspace{0.0cm}
    \input{files/No18-Upper.tex}
  \end{MyOuterBox}
