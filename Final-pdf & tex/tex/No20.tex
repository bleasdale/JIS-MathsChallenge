...
\newtcolorbox{MyOuterBox}{%
  ...
  colback=JISivory,
  colframe=JISpurple,
  title={\includegraphics[width=0.9cm,height=0.9cm]{images/JIS Final Logo FA-02.png}\raisebox{3mm}{\Large{Maths Challenge}\hspace{24em} \Large{\bfseries\sffamily 20}}},
}
...
\begin{document}
  ...
  \begin{MyOuterBox}
    ...
    \input{files/No20-Lower.tex}
    \vspace{0.4cm}
    \input{files/No20-Upper.tex}
  \end{MyOuterBox}
