...
\usepackage{siunitx}
\usepackage{graphicx}
\usepackage[margin=2.5cm,top=4.0cm]{geometry}
...
\AddToHook{shipout/background}{%
    \put (0in,-\paperheight){\includegraphics[width=\paperwidth,height=\paperheight]{images/happy-new-year.jpg}}%
}
...
\newtcolorbox{MyOuterBox}{%
  ...
  colback=JISivory,
  colframe=JISpurple,
  title={\includegraphics[width=0.9cm,height=0.9cm]{images/JIS Final Logo FA-02.png}\raisebox{3mm}{\Large{Maths Challenge}\hspace{20em} \Large{\bfseries\sffamily 15}}},
}
...
\begin{document}
  ...
  \begin{MyOuterBox}
    \iftoggle{SOLUTION}{Here are the full, or partial solutions.
      ...
      Welcome to the first Maths Challenge of 2023!\\
      Have a go at both questions!\\
      Drop your solution in the box in the staffroom by Tuesday.
    }
    \input{files/No15-Lower.tex}
    % \vspace{0.4cm}
    % \input{files/No15-Upper.tex}
  \end{MyOuterBox}
