...
\newtcolorbox{MyOuterBox}{%
  ...
  colback=JISivory,
  colframe=JISpurple,
  title={\includegraphics[width=0.9cm,height=0.9cm]{images/JIS Final Logo FA-02.png}\raisebox{3mm}{\Large{Maths Challenge}\hspace{24.0em} \Large{\bfseries\sffamily 25}}},
}
...
\begin{document}
  ...
  \begin{MyOuterBox}
    ...
    \input{files/No25-Lower.tex}
    \vspace{0.4cm}
    \input{files/No25-Upper.tex}
  \end{MyOuterBox}
