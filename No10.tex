...
\newtcolorbox{MyOuterBox}{%
  ...
  colback=JISivory,
  colframe=JISpurple,
  title={\includegraphics[width=0.9cm,height=0.9cm]{images/JIS Final Logo FA-02.png}\raisebox{3mm}{\Large{Maths Challenge}\hspace{26em} \Large{\bfseries\sffamily 10}}},
}
...
\begin{document}
  ...
  \begin{MyOuterBox}
    ...
    \input{files/No10-Lower.tex}
    \vspace{0.4cm}
    \input{files/No10-Upper.tex}
  \end{MyOuterBox}
